    ...
    Feature : [ 
        {
            ...
            title1 : "網頁設計",
            titel2 : "前後端課程教學",
            text: "帶你掌握程式技能轉職工程師，程式課程從入門到進階讓你快速上手，學員好評推薦轉職課程"
        },
        {
            url : "/showcases",
            title1 : "頂尖技術",
            titel2 : "網頁製作、專案開發",
            text: "工程服務、系統設計開發甚至系統架設，提供專業的建議與頂尖的技術。"
        },
        {
            url : "/training",
            title1 : "資訊軟體開發",
            titel2 : "技術顧問",
            text: "協助您將現有人力快速打造為 Ruby/Rails 團隊，無須經歷繁瑣的人才招募就有即戰力！!"
        },
        {
            url : "/posts/category/activity",
            title1 : "前後端工程師",
            titel2 : "社群經營",
            text: "Ruby 社群經營、舉辦各類活動，促進 Ruby 社群發展，歡迎前後端工程師分享交流。!"
        },
    ],
    Lecture : [
        {
            newOpen : true,
            apply : true,
            text : "工作上用得到的函數式程式設計：從觀念到實務 - 假日班",
        ...
        },
        {
            newOpen : false,
            apply : true,
            text : "Vue.js 與 Vuex 前端開發實戰課程 - 假日班",
