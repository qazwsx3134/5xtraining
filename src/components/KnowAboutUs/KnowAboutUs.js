    ...
    return (
      ...
      <div className="row">
        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          ...
          <p className="text text-center mb-4 mt-4">您可以看看<a className="text-red" href="/faq">常見問題</a>或者直接<a className="text-red" href="/contacts">線上洽詢</a>，會有親切的客服人員回答您的問題，<br></br> 也可以透過社群網站隨時關注我們的動態。
            </p></div>
