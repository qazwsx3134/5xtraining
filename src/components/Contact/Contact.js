                ...
                <div className="row">
                    ...
                    <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <form className="new_contact" id="new_contact" onSubmit={openModal}>
                            ...
                            <div className="form-group">
                                <textarea rows="5" className="form-control" placeholder="留下你的訊息" onChange={onMessageChange}  id="contact_message" required=""></textarea>
                            </div>
                            <input type="submit" name="commit" value="送出" className="btn btn-red btn-block" ></input>
                        </form>
                        ...
                        <Modal 
                            ...
                            <h3 className="modal__body">主題 : {subject}</h3>
                            <h4 className="modal__body">姓名 : {name}</h4>
                            <h4 className="modal__body">信箱 : {emailAddr}</h4>
                            <h4 className="modal__body">電話 : {tele}</h4>
                            <h4 className="modal__body">訊息 : {message}</h4>
