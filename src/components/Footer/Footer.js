...
const Footer = (props)=>{
  ...
  useEffect(() => {
    ...
    if (toTop === true) {
      var id = setInterval((()=>{window.scroll(0, window.pageYOffset - 200)}), 15)
                setTimeout(() => {
                  clearInterval(id);
                  settoTop(false)
      }, 350);
                ...
                <div className="row">
                  ...
                  <div className="col-12 col-md-8 col-xl-9 mt-3 mt-md-0">
                    <div className="mail-address">
                      ...
                      <br></br>
                      <p>地址： <a target="_blank" rel="noopener noreferrer" href="https://goo.gl/lz5v93">10046 台北市中正區衡陽路 7 號 5 樓</a></p>
                    </div>
                  </div>
